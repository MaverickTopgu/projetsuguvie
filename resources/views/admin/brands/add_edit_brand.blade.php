            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Ajouter Une Nouvelle Marque </h3>
                ...
                <div class="card-body">
                  ...
                  @else action="{{ url('admin/add-edit-brand/'.$brand['id']) }}"  @endif method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      <label for="section_name">Nom de la Marque </label>
                      <input type="text" class="form-control" id="brand_name" @if(!empty($brand['name'])) value=" {{ $brand['name'] }}" @else value="{{ old('brand_name') }}" @endif placeholder="Entrer le Nom de la Marque "name="brand_name">
