            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Ajouter Une Nouvelle Bannière de page d'accueil</h3>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" id="type" name="type" required>
                        ...
                        <option @if(!empty($banner['type'])&&$banner['type']=="Slider") selected @endif value="Slider">Coulissante</option>
                        <option @if(!empty($banner['type'])&&$banner['type']=="Fix") selected @endif value="Fix">Fixe</option>
                      </select>
                      
                    </div>
                    <div class="form-group">
                      <label for="image">Photo Bannière </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="link" @if(!empty($banner['link'])) value=" {{ $banner['link'] }}"
                       @else value="{{ old('link') }}" @endif placeholder="Entrer le Lien de la Bannière "name="link" >
                      
                    </div>
                    <div class="form-group">
                      <label for="title">Titre de la Bannière </label>
                      <input type="text" class="form-control" id="title" @if(!empty($banner['title'])) value=" {{ $banner['title'] }}"
                       @else value="{{ old('title') }}" @endif placeholder="Entrer le Titre de la Bannière "name="title" >
                      
                    </div>
                    <div class="form-group">
                      <label for="alt">Texte alternatif de la Bannière </label>
                      <input type="text" class="form-control" id="alt" @if(!empty($banner['alt'])) value=" {{ $banner['alt'] }}"
                       @else value="{{ old('alt') }}" @endif placeholder="Entrer le Texte alternatif de la Bannière "name="alt" >
