        ...
        <div class="container clearfix">
                ...
                <ul class="primary-nav g-nav">
                    <li>
                        <a href="tel:+111222333">
                            ...
                            Telephone:+212 6 35 75 67 74</a>
                    </li>
                    <li>
                        <a href="mailto:info@sitemakers.in">
                            <i class="fas fa-envelope u-c-brand u-s-m-r-9"></i>
                            E-mail: sekou.siraman01@gmail.com
                        </a>
                    </li>
                </ul>
            </nav>
            <nav>
                <ul class="secondary-nav g-nav">
                    <li>
                        <a>@if(Auth::check()) Mon Compte @else Se Connecter / S'inscrire @endif
                    ...
                    <li>
                        ...
                        <ul class="g-dropdown" style="width:90px">
                            <li>
                                <a href="#" class="u-c-brand">(CFA) Franc(s)</a>
                            </li>
                            <li>
                                <a href="#">(£) GBP</a>
                            </li>
            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        <a href="{{ url('front/index.blade.php') }}">
                            <img src="{{asset('front/images/main-logo/DKBA-logo.png') }}" alt="Stack Developers" class="app-brand-logo">
                        </a>
                    </div>
                </div>
