...
<head>
    ...
    <title>Compte Vendeur Confirmé</title>
</head>
<body>
    <table>
        <tr>
        ...
        <tr>
            <td>Votre adresse email vendeur a été confirmée. Veuillez vous connecter à votre compte afin de remplir les informations personnelles et de vente nécessaires à l'approbation de votre compte.</td>
        </tr>
        <tr>
            <td>&nbsp;<br></td>
        </tr>
